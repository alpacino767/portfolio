...
const Testimonials = () => {
   ...
   return (
    <section 
    id='testimonials' className='pt-32 pb-16'>
        {/* heading */}
        <motion.div
            className='md:w-1/3 text-center md:text-left'
             ...
             variants={{
                ...
                <p className='mt-10 '>
                Nulla porta lorem libero, ac luctus nibh efficitur sed. Vestibulum iaculis a nisi non auctor. Etiam ac nunc leo. Mauris in tincidunt risus, in vestibulum nulla. Praesent at imperdiet lacus. Nam sceleri
                </p>
            ...
            <div className='md:flex md:justify-between gap-8'>
                <motion.div  
                 ...
                 variants={{
                    ...
                    <p className='text-center text-xl'> Nulla porta lorem libero, ac luctus nibh efficitur sed.</p>
